function initInjuryMap(data) {
    ...
    function filterData() {
        ...
        return data.filter(d => {
            ...
            console.log(`Incident Date: ${incidentDate}, Year: ${incidentDate.getFullYear()}`); // Log the date to debug
  
            return (
                incidentDate.getFullYear() >= 2016 && 
                incidentDate.getFullYear() <= selectedYear &&
    ...
    function updateMap() {
        ...
        console.log(filteredData); // Log filtered data to verify date filtering
    ...
    d3.select("#reset-filters").on("click", () => {
        ...
        dateRangeSlider.property("value");
        yearDisplay.text(`Selected Year: `);
        updateMap();
    });
